                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                        ...
                                        <td v-text="ingreso.tipo_pago"></td>
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Total</label>
                                    <input type="text" class="form-control" v-model="total" placeholder="000x">
                                </div>
                            </div>
                       ...
                       <div class="form-group row border">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Retiro <span style="color:red;" v-show="idarticulo==0">(*Seleccione)</span></label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Enviar <span style="color:red;" v-show="total==0">(*Ingrese)</span></label>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td>
                                                <input v-model="detalle.tipo_pago" type="number" value="3" class="form-control">
                                            </td>
                                            <td>
                                                <input v-model="detalle.total" type="number" value="2" class="form-control">
                                            </td>
                                            <td>
                                                {{detalle.toal*detalle.cantidad}}
                                            </td>
                                        </tr>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-primary" @click="registrarIngreso()">Registrar Pago</button>
                            </div>
                        </div>
                    </div>
                    </template>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                                            <td v-text="detalle.usuario">
                                            </td>
                                            <td v-text="detalle.total">
                                            </td>
